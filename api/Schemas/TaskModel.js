...
const TaskSchema = new mongoose.Schema({
  ...
  priority: {type: String, enum:["low", "medium", "high", "urgent"], default: "undecided", lowercase: true},
  link: {type: String, required: false, minlength: 8, maxlength: 255},
  deadline: {type: Date, required: false},
  subtasks: {type: [SubTaskSchema], default: Array},
  category: {type:String, default: "Unspecified", lowercase: true, unique: true, minlength: 3, maxlength: 255}
})
